...
use crate::vm::{Error as VmError, PostMigrationLifecycleEvent, RestoreVmShell, Vm, VmState};
use crate::vm_config::{
...
impl Vmm {
    ...
    ) -> std::result::Result<RestoreVmShell, MigratableError>
    where
        T: Read,
    {
        ...
        let restore_vm = memory_manager.lock().unwrap().vm.clone();
